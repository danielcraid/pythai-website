  ...
  function AccountSettings({ a }) {
    ...
    return h(Card, { variant: "raised", padding: "30px", style: { marginBottom: 30 } },
      ...
      h("div", { style: { marginTop: 8 } },
        ...
        h(SetRow, { title: T("Rituals mit Warren einrichten", "Set up rituals with Warren"), sub: T("Warren fragt dich in zwei Minuten durch — was du h\xF6ren willst, wie oft, und ob er einfache Sprache nutzen soll. \xC4nderbar jederzeit.", "Warren walks you through it in two minutes — what you want to hear, how often, and whether he should use simple language. Change anytime."), control: h(Button, { variant: "oracle", size: "sm", "data-sfx": "", onClick: () => { if (typeof window.PYchatOpen === "function") window.PYchatOpen(T("Richte mit mir meine Rituals ein.", "Set up my rituals with me.")); } }, T("Mit Warren starten", "Start with Warren")) }),
        h(Divider),
