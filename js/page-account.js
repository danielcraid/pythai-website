  ...
  function AccountSettings({ a }) {
    ...
    return h(Card, { variant: "raised", padding: "30px", style: { marginBottom: 30 } },
      ...
      h("div", { style: { marginTop: 8 } },
        ...
        h(Divider),
        h(SetRow, { title: T("E-Mail-Adresse", "Email address"), sub: T("Login & alle Mails. Ändern kommt bald.", "Login & all emails. Changing is coming soon."), control: h("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" } }, h("span", { style: { fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--text-secondary)", maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, a.email || ""), h(Button, { variant: "chrome", size: "sm", disabled: true }, T("Ändern (bald)", "Change (soon)"))) }),
        h(Divider),
        ...
        h(SetRow, { title: T("Mobilnummer", "Mobile number"), sub: T("F\xFCr Verify-Codes & Service-Alerts. Kein Marketing. Neue Nummer wird per SMS-Code best\xE4tigt.", "For verify codes & service alerts. No marketing. A new number is confirmed via SMS code."), control: (verified && !editingMobile)
          ? h("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" } }, h("span", { style: { fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--text-secondary)" } }, phone || a.phone || ""), h(Badge, { tone: "oracle", variant: "outline" }, T("verifiziert ✓", "verified ✓")), h(Button, { variant: "chrome", size: "sm", disabled: true }, T("\xC4ndern (bald)", "Change (soon)")))
          : (editingMobile
