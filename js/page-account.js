...
`;
  ...
  function Dashboard({ a, justJoined }) {
    ...
    return h("div", { style: { maxWidth: 680, margin: "0 auto" } },
      ...
      tier === "admin" && h("a", { href: "admin.html", style: { display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 22, padding: "10px 18px", borderRadius: 999, border: "1px solid var(--border-oracle)", background: "rgba(212,169,78,0.07)", color: "var(--text-oracle)", fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none" } }, T("Admin-Bereich", "Admin area"), " →"),
