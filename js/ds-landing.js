(() => {
  ...
  function Pricing({ onEnter }) {
    const tiers = [
      ...
      { name: "Inner Circle", price: "99 \u20AC", per: "/ mo", tone: "oracle", cta: "oracle", feat: ["Full daily reading + levels", "Low & mid-risk setups", "AFTERNOON BRIEF, EOD & weekend briefings", "Chat with Warren — with context", "Research & chart tools"], highlight: true },
      { name: "Syndicate", price: "298 \u20AC", per: "/ mo", tone: "oxblood", cta: "oxblood", comingSoon: true, feat: ["Everything in Inner Circle", "All risk classes + live updates", "Phone with Warren", "Portfolio tracker"], highlight: false }
    ];
