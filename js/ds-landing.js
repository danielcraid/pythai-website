(() => {
  ...
  function Pricing({ onEnter }) {
    const tiers = [
      ...
      { name: "Inner Circle", price: "69 \u20AC", per: "/ Monat", tone: "oracle", cta: "oracle", feat: ["Full daily reading + levels", "Low & mid-risk setups", "AFTERNOON BRIEF, EOD & weekend briefings", "Chat with Warren — with context", "Research & chart tools"], highlight: true },
      { name: "Syndicate", price: "289 \u20AC", per: "/ Monat", tone: "oxblood", cta: "oxblood", comingSoon: true, feat: ["Everything in Inner Circle", "All risk classes + live updates", "Phone with Warren", "Portfolio tracker"], highlight: false }
    ];
