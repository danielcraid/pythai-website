(() => {
  ...
  function Pricing({ onEnter }) {
    const tiers = [
      ...
      { name: "Inner Circle", price: "99 \u20AC", per: "/ mo", tone: "oracle", cta: "oracle", feat: ["Full daily reading + levels", "Low & mid-risk setups", "AFTERNOON BRIEF, EOD & weekend briefings", "Email reply from Warren", "Research & chart tools"], highlight: true },
