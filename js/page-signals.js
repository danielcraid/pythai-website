  ...
  function Emometer() {
    ...
    return h(PySection, null,
      h(Card, { variant: "oracle", padding: "30px 30px 22px" },
        h("div", { style: { paddingBottom: 18, borderBottom: "1px solid var(--border-subtle)" } },
          h("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, flexWrap: "wrap" } },
            h("div", { style: { fontFamily: "var(--font-oracle)", fontSize: "clamp(30px,3.8vw,40px)", fontWeight: 400, letterSpacing: "-0.01em", lineHeight: 1, color: "var(--oracle)" } }, "EmoMeter"),
          ...
          h("p", { style: { fontFamily: "var(--font-ui)", fontSize: 14, lineHeight: 1.6, color: "var(--text-secondary)", margin: "13px 0 0", maxWidth: "64ch" } }, T("Der EmoMeter destilliert die Stimmung der globalen Hot-Topics: ein Ensemble aus Maschinenhirnen scannt werktags rund um die Uhr über 10.000 Schlagzeilen, Meldungen und Marktsignale und verdichtet sie zu einem relevanz-gewichteten Sentiment. Stündlich neu berechnet, Mo–Fr von 06:30 bis 22:30 — eine Kontext-Anzeige, kein Handelssignal.", "The EmoMeter distills the mood of the world's hot topics: an ensemble of machine minds scans over 10,000 headlines, reports and market signals around the clock on weekdays, condensing them into a relevance-weighted sentiment. Recomputed hourly, Mon–Fri from 06:30 to 22:30 — a context display, not a trading signal."))),
        h("div", { style: { padding: "22px 0 2px" } },
          ...
          h("div", { style: { display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap", marginBottom: 18 } },
            h("div", { style: { fontFamily: "var(--font-ui)", fontWeight: 700, fontSize: "clamp(24px,3.6vw,34px)", letterSpacing: "0.005em", lineHeight: 1.06, color: "var(--parchment)" } }, emoMood(a.score).toUpperCase()),
