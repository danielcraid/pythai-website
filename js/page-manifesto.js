(() => {
  ...
  function Hero() {
    return /* @__PURE__ */ React.createElement("header", { style: {
      ...
      display: "flex",
      alignItems: "center"
    } }, /* @__PURE__ */ React.createElement("img", { src: "assets/imagery/warren-oracle-portrait.png", alt: "Warren, the Masterbrain", style: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 22%", opacity: 0.5 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "radial-gradient(70% 65% at 50% 42%, rgba(8,9,12,0.30) 0%, rgba(8,9,12,0.80) 66%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(8,9,12,0.65) 0%, transparent 30%, transparent 64%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", maxWidth: 820, margin: "0 auto", padding: "120px 40px", textAlign: "center" } }, /* @__PURE__ */ React.createElement(PyEyebrow, null, "Manifesto"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 400, letterSpacing: "-0.02em", fontSize: "clamp(44px,7vw,84px)", lineHeight: 1.02, margin: 0, color: "var(--text-primary)" } }, "The oracle's creed."), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: 19, lineHeight: 1.6, color: "var(--text-secondary)", maxWidth: 560, margin: "22px auto 0" } }, T("Wie Warren spricht \u2014 und was PYTHAI tut und nicht tut.", "How Warren speaks, and what PYTHAI will and will not do."))));
  }
  function App() {
