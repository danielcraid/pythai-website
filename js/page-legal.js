(() => {
  ...
  function App() {
    ...
    const SECTIONS = [
      ...
      ["terms", T("AGB", "Terms"), [
        T("Entwurf — Struktur zur anwaltlichen Ausformulierung. Anbieter: CRAID GmbH (PYTHAI ist eine AI-Unit der CRAID GmbH).", "Draft — structure for legal finalisation. Provider: CRAID GmbH (PYTHAI is an AI unit of CRAID GmbH)."),
