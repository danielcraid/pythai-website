(() => {
  ...
  function Auth() {
    ...
    function submit(e) {
      ...
      }).catch(() => setMsg(T("Etwas ging schief. Versuch es gleich nochmal.", "Something failed. Try again in a moment.")));
    }
    return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 420, width: "100%", margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 28 } }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo/pythai-oculus.svg", alt: "", style: { width: 56, height: 56, margin: "0 auto 18px", filter: "drop-shadow(0 0 20px var(--glow-oracle))" } }), /* @__PURE__ */ React.createElement(PyEyebrow, null, "Seek counsel"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 400, fontSize: 40, letterSpacing: "-0.02em", margin: 0, color: "var(--text-primary)" } }, "Enter the Sanctum."), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: 15, lineHeight: 1.6, color: "var(--text-secondary)", margin: "14px 0 0" } }, T("Kein Passwort. Das Orakel schickt dir einen einmaligen Link.", "No password. The oracle sends you a one-time link."))), /* @__PURE__ */ React.createElement("button", { onClick: google, style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "var(--parchment)", color: "#1A1206", border: "none", borderRadius: 6, padding: "13px 16px", fontFamily: "var(--font-ui)", fontWeight: 600, fontSize: 15, cursor: "pointer" } }, /* @__PURE__ */ React.createElement(GoogleG, null), " Continue with Google"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, margin: "20px 0" } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--border-subtle)" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--text-muted)" } }, T("oder", "or")), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--border-subtle)" } })), /* @__PURE__ */ React.createElement("form", { onSubmit: submit }, /* @__PURE__ */ React.createElement("input", { style: fld, type: "email", placeholder: "you@example.com", value: email, onChange: (e) => setEmail(e.target.value), "aria-label": "Email", disabled: sent }), /* @__PURE__ */ React.createElement(Button, { variant: "oracle", full: true, type: "submit" }, sent ? T("Link erneut senden", "Resend link") : T("Schick mir den Link", "Email me a link")), /* @__PURE__ */ React.createElement("label", { style: { display: "flex", gap: 10, alignItems: "flex-start", textAlign: "left", marginTop: 14, cursor: "pointer" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: consent, onChange: (e) => setConsent(e.target.checked), style: { marginTop: 3, accentColor: "var(--oracle)", width: 16, height: 16, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-ui)", fontSize: 12.5, lineHeight: 1.55, color: "var(--text-muted)" } }, T("Schick mir Warrens t\xE4gliche Readings per E-Mail. Optional, jederzeit abbestellbar.", "Send me Warren\u2019s daily readings by email. Optional, unsubscribe anytime.")))), /* @__PURE__ */ React.createElement("div", { style: { minHeight: 24, marginTop: 16, textAlign: "center", fontFamily: "var(--font-oracle)", fontStyle: "italic", fontSize: 18, color: "var(--text-oracle)" } }, msg), /* @__PURE__ */ React.createElement("p", { style: { textAlign: "center", fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--text-muted)", marginTop: 14, lineHeight: 1.6 } }, T("Mit der Anmeldung akzeptierst du die ", "By signing in you accept the "), /* @__PURE__ */ React.createElement("a", { href: "legal.html#terms", style: { color: "var(--text-secondary)" } }, T("AGB", "terms")), T(" und den ", " and "), /* @__PURE__ */ React.createElement("a", { href: "legal.html#privacy", style: { color: "var(--text-secondary)" } }, T("Datenschutz", "privacy notice")), T(". PYTHAI erbringt keine Anlageberatung.", ". PYTHAI provides no investment advice.")));
  }
  function App() {
