(() => {
  ...
  function Auth() {
    ...
    function verifyCode(c) {
      ...
      fetch(API + "/api/login/verify-code", {
        method: "POST", credentials: "include",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email: email.trim(), code: c })
      }).then((r) => {
        if (r.ok) { window.location.href = "account.html"; return null; }
        return r.json().catch(() => ({})).then((j) => {
          setVerifying(false);
          const er = String((j && j.error) || "").toLowerCase();
          let m;
          if (r.status === 429 || er.indexOf("lock") > -1 || er.indexOf("attempt") > -1 || er.indexOf("many") > -1) m = T("Zu viele Versuche. Fordere oben einen neuen Link an.", "Too many attempts. Request a new link above.");
          else if (er.indexOf("expired") > -1) m = T("Code abgelaufen — fordere einen neuen Link an.", "Code expired — request a new link.");
          else m = T("Code stimmt nicht. Prüf die Mail.", "Code doesn't match. Check the email.");
          setCodeErr(m);
        });
      }).catch(() => { setVerifying(false); setCodeErr(T("Netzwerkfehler — versuch es nochmal.", "Network error — try again.")); });
    }
    return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 420, width: "100%", margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 28 } }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo/pythai-oculus.svg", alt: "", style: { width: 56, height: 56, margin: "0 auto 18px", filter: "drop-shadow(0 0 20px var(--glow-oracle))" } }), /* @__PURE__ */ React.createElement(PyEyebrow, null, "Login"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 400, fontSize: 40, letterSpacing: "-0.02em", margin: 0, color: "var(--text-primary)" } }, "Enter the Sanctum."), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: 15, lineHeight: 1.6, color: "var(--text-secondary)", margin: "14px 0 0" } }, T("Login per Magic-Link — kein Passwort. Das Orakel schickt dir einen einmaligen Link an deine E-Mail.", "Login via magic link — no password. The oracle sends a one-time link to your email."))), /* @__PURE__ */ React.createElement("button", { onClick: google, style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "var(--parchment)", color: "#1A1206", border: "none", borderRadius: 6, padding: "13px 16px", fontFamily: "var(--font-ui)", fontWeight: 600, fontSize: 15, cursor: "pointer" } }, /* @__PURE__ */ React.createElement(GoogleG, null), " Continue with Google"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, margin: "20px 0" } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--border-subtle)" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--text-muted)" } }, T("oder", "or")), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--border-subtle)" } })), /* @__PURE__ */ React.createElement("form", { onSubmit: submit }, /* @__PURE__ */ React.createElement("input", { style: fld, type: "email", placeholder: "you@example.com", value: email, onChange: (e) => setEmail(e.target.value), "aria-label": "Email", disabled: sent }), /* @__PURE__ */ React.createElement("label", { style: { display: "flex", gap: 10, alignItems: "flex-start", textAlign: "left", margin: "2px 0 16px", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: consent, onChange: (e) => setConsent(e.target.checked), style: { marginTop: 3, accentColor: "var(--oracle)", width: 16, height: 16, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-ui)", fontSize: 13, lineHeight: 1.55, color: "var(--text-secondary)" } }, T("Ja \u2014 Warren darf sprechen. Ich erlaube PYTHAI, mir Readings & Briefings per E-Mail zu senden. Ohne dieses Ja bleibt das Orakel stumm; jederzeit widerruflich.", "Yes \u2014 let Warren speak. I allow PYTHAI to email me the readings & briefings. Without this yes the oracle stays silent; revocable anytime."))), /* @__PURE__ */ React.createElement(Button, { variant: "oracle", full: true, type: "submit", loading: busy, disabled: !consent || busy, "data-sfx": "login-button" }, busy ? T("Warren wird gerufen…", "Summoning Warren…") : sent ? T("Link erneut senden", "Resend link") : T("Schick mir den Link", "Email me a link"))), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => { window.location.href = "inner-circle.html#waitlist"; }, style: { width: "100%", marginTop: 12, background: "rgba(174,180,190,0.07)", border: "1px solid var(--border-strong)", color: "var(--chrome)", borderRadius: 6, padding: "13px 16px", fontFamily: "var(--font-ui)", fontWeight: 600, fontSize: 14.5, cursor: "pointer" } }, T("Noch kein Member? Hier anfragen.", "Not a member yet? Request access.")), sent ? /* @__PURE__ */ React.createElement("div", { style: { marginTop: 18, padding: "22px", borderRadius: 12, border: "1px solid var(--border-oracle)", background: "rgba(212,169,78,0.06)", boxShadow: "0 0 28px var(--glow-oracle-soft)", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 46, height: 46, margin: "0 auto 14px", borderRadius: "50%", border: "1px solid var(--border-oracle)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-oracle)" } }, /* @__PURE__ */ React.createElement("svg", { width: 22, height: 22, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.6, strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: 3, y: 5, width: 18, height: 14, rx: 2 }), /* @__PURE__ */ React.createElement("path", { d: "m3 7 9 6 9-6" }))), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-oracle)", fontWeight: 400, fontSize: 26, margin: 0, color: "var(--text-primary)" } }, T("Schau in deine Mails.", "Check your inbox.")), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: 14.5, lineHeight: 1.6, color: "var(--text-secondary)", margin: "10px 0 0" } }, T("Warren hat dir einen einmaligen Link an ", "Warren has sent a one-time link to "), /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--text-primary)" } }, email), T(" geschickt. \xD6ffne ihn, um das Sanctum zu betreten.", ". Open it to enter the sanctum.")), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.04em", color: "var(--text-muted)", margin: "14px 0 0", lineHeight: 1.6 } }, T("Keine Mail in 1–2 Minuten? Sieh im Spam nach — oder sende den Link erneut.", "No email within 1–2 min? Check spam — or resend the link.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 18, paddingTop: 16, borderTop: "1px solid var(--border-subtle)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-ui)", fontSize: 13.5, lineHeight: 1.55, color: "var(--text-secondary)", marginBottom: 10 } }, T("Öffnet sich der Link im falschen Browser? Gib einfach den 6-stelligen Code aus der Mail ein:", "Link opening in the wrong browser? Just enter the 6-digit code from the email:")), /* @__PURE__ */ React.createElement("input", { style: Object.assign({}, fld, { letterSpacing: "0.4em", textAlign: "center", fontFamily: "var(--font-mono)", fontSize: 22, marginBottom: 0 }), inputMode: "numeric", maxLength: 6, placeholder: "······", value: code, onChange: (e) => { const v = e.target.value.replace(/\D/g, "").slice(0, 6); setCode(v); setCodeErr(""); if (v.length === 6) verifyCode(v); } }), codeErr ? /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--text-warn, #d8a34a)", marginTop: 8 } }, codeErr) : null, verifying ? /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--text-muted)", marginTop: 8 } }, T("Prüfe Code…", "Checking code…")) : null)) : /* @__PURE__ */ React.createElement("div", { style: { minHeight: 24, marginTop: 16, textAlign: "center", fontFamily: "var(--font-oracle)", fontStyle: "italic", fontSize: 18, color: "var(--text-oracle)" } }, msg), /* @__PURE__ */ React.createElement("p", { style: { textAlign: "center", fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--text-muted)", marginTop: 14, lineHeight: 1.6 } }, T("Mit der Anmeldung akzeptierst du die ", "By signing in you accept the "), /* @__PURE__ */ React.createElement("a", { href: "legal.html#terms", style: { color: "var(--text-secondary)" } }, T("AGB", "terms")), T(" und den ", " and "), /* @__PURE__ */ React.createElement("a", { href: "legal.html#privacy", style: { color: "var(--text-secondary)" } }, T("Datenschutz", "privacy notice")), T(". PYTHAI erbringt keine Anlageberatung.", ". PYTHAI provides no investment advice.")));
  }
  function App() {
