  ...
  function Auth() {
    ...
    function submit(e) {
      ...
      fetch(API + "/api/login/start", {
        ...
        body: JSON.stringify({ email: email.trim(), lang: window.PYi18n.lang })
      }).then((r) => {
        if (!r.ok) throw 0;
        setSent(true);
