(() => {
  ...
  window.PYsfx = (function () {
    ...
    try { ["menue-account", "menue-login", "request-sanctum-button", "login-button", "button-004-toggle", "button-002-itemopen", "button-001-itemclose", "menue-in-mybook", "button-all", "delete", "menue", "warren-chat"].forEach(get); } catch (e) { }
