(() => {
  ...
  function App() {
    ...
    if (gate === "locked") return h("div", null, h(SiteNav, { active: "chartomat.html" }), h("section", { style: { minHeight: "calc(100vh - var(--nav-h))", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 24px", textAlign: "center" } }, h("div", { style: { maxWidth: 480 } }, h("img", { src: "assets/logo/pythai-oculus.svg", alt: "", style: { width: 58, height: 58, margin: "0 auto 22px", opacity: 0.7 } }), h(PyEyebrow, null, "Inner Circle"), h("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 400, fontSize: 40, margin: "8px 0 0", color: "var(--text-primary)" } }, T("Der Chartomat lebt im Sanctum.", "The Chartomat lives in the sanctum.")), h("p", { style: { fontFamily: "var(--font-ui)", fontSize: 16, lineHeight: 1.6, color: "var(--text-secondary)", margin: "16px 0 28px" } }, T("Chart-Analyse mit Erläuterung ist dem Inner Circle vorbehalten.", "Chart analysis with explanation is reserved for the Inner Circle.")), h(Button, { variant: "oracle", onClick: () => { window.location.href = "account.html"; } }, T("Zum Inner Circle", "Go to Inner Circle")))), h(SiteFooter, null));
