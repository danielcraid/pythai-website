(() => {
  ...
  const { PyReadingTeaser, PyPricing, SiteNav, SiteFooter, PySection, PyH2, PyEyebrow } = window;
  ...
  function How() {
    const STEPS = [
      ...
      ["The reasoning, the levels", T("Entry, Stop, Target, der Catalyst und warum die Masse falsch bepreist. Die vollst\xE4ndige Reading liegt im Sanctum.", "Entry, stop, target, the catalyst, and why the crowd is mispriced. The full reading lives inside the sanctum.")]
    ];
