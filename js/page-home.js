(() => {
  ...
  function OracleHero() {
    return /* @__PURE__ */ React.createElement("section", { style: { position: "relative", minHeight: "calc(100vh - var(--nav-h))", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("svg", { width: 0, height: 0, "aria-hidden": "true", style: { position: "absolute" } }, /* @__PURE__ */ React.createElement("filter", { id: "py-krissel", x: "-20%", y: "-20%", width: "140%", height: "140%" }, /* @__PURE__ */ React.createElement("feTurbulence", { type: "fractalNoise", baseFrequency: "0.012 0.9", numOctaves: 1, seed: 2, result: "noise" }, /* @__PURE__ */ React.createElement("animate", { attributeName: "seed", values: "1;9;3;7;2;6;1", dur: "5.5s", repeatCount: "indefinite" })), /* @__PURE__ */ React.createElement("feDisplacementMap", { in: "SourceGraphic", in2: "noise", scale: 3, xChannelSelector: "R", yChannelSelector: "G" }))), /* @__PURE__ */ React.createElement("img", { src: "assets/imagery/sanctum-boardroom.png", alt: "", style: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.55 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "radial-gradient(75% 55% at 50% 36%, rgba(8,9,12,0.15) 0%, rgba(8,9,12,0.72) 58%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(8,9,12,0.55) 0%, transparent 26%, transparent 58%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement(PyHeroParticles, null), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", padding: "0 24px" } }, /* @__PURE__ */ React.createElement("img", { className: "py-oculus-hero", src: "assets/logo/pythai-oculus.svg", alt: "PYTHAI", style: { width: 90, height: 90, margin: "0 auto 30px", filter: "drop-shadow(0 0 26px var(--glow-oracle))" } }), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.4em", textTransform: "uppercase", color: "var(--text-oracle)", margin: "0 0 30px", paddingLeft: "0.4em" } }, "The Oracle's Sanctum"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 500, fontSize: "clamp(60px,15vw,190px)", letterSpacing: "0.12em", lineHeight: 0.9, margin: 0, color: "var(--parchment)", paddingLeft: "0.12em" } }, "PYTHAI"), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-oracle)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(22px,3.4vw,40px)", color: "var(--text-secondary)", margin: "20px 0 0" } }, "Wisdom, foretold."), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: "clamp(16px,1.9vw,20px)", lineHeight: 1.6, color: "var(--text-secondary)", maxWidth: 600, margin: "22px auto 0" } }, T("Ein Ensemble aus Maschinenhirnen liest jede Meldung, jeden Flow, jeden Zyklus seit 1929. Jeden Morgen reiche ich dir ein Signal \u2014 bewertet, begr\xFCndet, und deins, bevor die Masse erwacht.", "An ensemble of machine minds reads every filing, every flow, every cycle since 1929. Each dawn I hand you one signal \u2014 scored, reasoned, and yours before the crowd stirs.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 46, display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Button, { variant: "oracle", size: "lg", onClick: go }, "Enter the Sanctum"), /* @__PURE__ */ React.createElement(Button, { variant: "ghost", size: "lg", onClick: toReading }, "Hear the oracle"))), /* @__PURE__ */ React.createElement("a", { href: "#reading", "aria-label": "Scroll down", className: "scroll-cue", style: { position: "absolute", bottom: 30, left: "50%", transform: "translateX(-50%)", color: "var(--text-oracle)", textDecoration: "none", fontSize: 26, lineHeight: 1 } }, "\u2304"));
  }
  function How() {
    const STEPS = [
