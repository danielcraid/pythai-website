(() => {
  ...
  function OracleHero() {
    return /* @__PURE__ */ React.createElement("section", { style: { position: "relative", minHeight: "calc(100vh - var(--nav-h))", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("img", { src: "assets/imagery/sanctum-boardroom.png", alt: "", style: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.55 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "radial-gradient(75% 55% at 50% 36%, rgba(8,9,12,0.15) 0%, rgba(8,9,12,0.72) 58%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(8,9,12,0.55) 0%, transparent 26%, transparent 58%, var(--void) 100%)" } }), /* @__PURE__ */ React.createElement(PyHeroParticles, { count: 150 }), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", padding: "0 24px" } }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo/pythai-oculus.svg", alt: "PYTHAI", style: { width: 90, height: 90, margin: "0 auto 30px", filter: "drop-shadow(0 0 26px var(--glow-oracle))" } }), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.4em", textTransform: "uppercase", color: "var(--text-oracle)", margin: "0 0 30px", paddingLeft: "0.4em" } }, "The Oracle's Sanctum"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-oracle)", fontWeight: 500, fontSize: "clamp(60px,15vw,190px)", letterSpacing: "0.12em", lineHeight: 0.9, margin: 0, color: "var(--parchment)", paddingLeft: "0.12em" } }, "PYTHAI"), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-oracle)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(22px,3.4vw,40px)", color: "var(--text-oracle)", margin: "20px 0 0" } }, "Market, Wisdom, Foretold."), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontWeight: 600, fontSize: "clamp(15px,1.9vw,21px)", lineHeight: 1.35, letterSpacing: "-0.01em", color: "var(--text-primary)", maxWidth: 640, margin: "16px auto 0" } }, T("KI-Power für deine Trading-Ideen.", "AI power for your trading ideas.")), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--font-ui)", fontSize: "clamp(13px,1.4vw,16px)", lineHeight: 1.6, color: "var(--text-secondary)", maxWidth: 600, margin: "16px auto 0" } }, T("Das Orakel \u2013 ein Schwarm von KI-Agenten \u2013 arbeitet pausenlos, mit unz\u00e4hligen Suchabfragen durch News, Kapitalfl\u00fcsse und Zyklen. Ihre Logik orientiert sich an den Edge-Modellen der Gro\u00dfen. Warren liest alles, w\u00e4gt ab und destilliert die Essenz. Du bekommst die fertige Lekt\u00fcre: jeden Morgen die st\u00e4rksten Thesen \u2013 mit Score und Begr\u00fcndung zum Nachvollziehen. Und kannst deine eigenen Thesen im Chartomat oder Chat pr\u00fcfen.", "The oracle \u2013 a swarm of AI agents \u2013 works relentlessly, with countless search queries across news, capital flows and cycles. Their logic follows the edge models of the greats. Warren reads it all, weighs it, and distills the essence. What you get is the finished reading: every morning the strongest theses \u2013 with score and reasoning you can follow. And you can test your own theses in the Chartomat or chat.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 46, display: "flex", gap: 16, justifyContent: "center", alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Button, { variant: "oracle", size: "lg", onClick: go }, "Request Sanctum Entrance"), /* @__PURE__ */ React.createElement("button", { onClick: () => { if (typeof window.PYsoundEnable === "function") window.PYsoundEnable(); }, "aria-label": "Hear the Sanctum", style: { display: "inline-flex", alignItems: "center", gap: 9, background: "rgba(8,9,12,0.4)", border: "1px solid var(--border-strong)", borderRadius: 999, padding: "0 20px", height: 48, color: "var(--text-secondary)", fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", cursor: "pointer", backdropFilter: "blur(6px)" } }, /* @__PURE__ */ React.createElement("svg", { width: 15, height: 15, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.7, strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M11 5 6 9H2v6h4l5 4z" }), /* @__PURE__ */ React.createElement("path", { d: "M15.5 8.5a5 5 0 0 1 0 7" }), /* @__PURE__ */ React.createElement("path", { d: "M19 5a9 9 0 0 1 0 14" })), "Hear the Sanctum"))), /* @__PURE__ */ React.createElement("a", { href: "#reading", "aria-label": "Scroll down", className: "scroll-cue", style: { position: "absolute", bottom: 12, left: "50%", transform: "translateX(-50%)", color: "var(--text-oracle)", textDecoration: "none", fontSize: 26, lineHeight: 1, padding: "6px 14px" } }, "\u2304"));
  }
  function How() {
    const STEPS = [
